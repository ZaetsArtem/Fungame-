...
fwrite($f, "<tr><td>".$_SESSION['login']."</td><td>".$vik."</td><td>".$mf."</td><td>1</td><td>4</td><td>".$_POST['click']."</td><td>".$data."</td><td>10</td><td>так</td><td>".$_POST['timer']."</td><td>".$d."</td><td>".$range."</td></tr>");  
$id1 = "4";
